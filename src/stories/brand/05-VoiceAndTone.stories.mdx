...
<Meta title="Brand/Voz y Tono" />

# Voz y Tono

La forma en que comunicamos es tan importante como lo que comunicamos. La voz de Khipu es consistente, mientras que el tono se adapta al contexto.

<h2 style={{ marginTop: '64px', border: 'none', borderBottom: 'none' }}>🎤 Voz de marca</h2>
...
<h2 style={{ marginTop: '64px', border: 'none', borderBottom: 'none' }}>✍️ Guías de redacción</h2>
...
<h2 style={{ marginTop: '64px', border: 'none', borderBottom: 'none' }}>📝 Microcopy: elementos de UI</h2>
...
<h2 style={{ marginTop: '64px', border: 'none', borderBottom: 'none' }}>📌 Uso de puntuación</h2>
