import { colors, fontFamilies, fontWeights, fontSizes, borderRadius } from '../../../tokens';
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '32px', marginTop: '32px', marginBottom: '48px' }}>
      ...
      <div>
        ...
        <p style={{ fontSize: fontSizes.sm, lineHeight: '1.6', marginBottom: '16px' }}>
          El púrpura es nuestro color de marca distintivo y representa:
        </p>
        <ul style={{ fontSize: fontSizes.sm, lineHeight: '1.6', marginBottom: '16px', paddingLeft: '20px' }}>
        ...
        <h4 style={{ fontSize: '16px', fontWeight: fontWeights.semiBold, marginBottom: '12px' }}>Cuándo usarlo</h4>
        <ul style={{ fontSize: fontSizes.sm, lineHeight: '1.6', paddingLeft: '20px' }}>
...
export function SemanticColorCards() {
  return (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '24px', marginTop: '32px', marginBottom: '48px' }}>
      {/* Info */}
      <div>
        <div style={{ background: colors.info.main, height: '120px', borderRadius: borderRadius.lg, marginBottom: '8px' }} />
        <div style={{
          fontFamily: fontFamilies.mono,
          fontSize: '13px',
          color: colors.text.footer,
      ...
      {/* Success */}
      <div>
        <div style={{ background: colors.success.main, height: '120px', borderRadius: borderRadius.lg, marginBottom: '8px' }} />
        <div style={{
          fontFamily: fontFamilies.mono,
          fontSize: '13px',
          color: colors.text.footer,
      ...
      {/* Warning */}
      <div>
        <div style={{ background: colors.warning.main, height: '120px', borderRadius: borderRadius.lg, marginBottom: '8px' }} />
        <div style={{
          fontFamily: fontFamilies.mono,
          fontSize: '13px',
          color: colors.text.footer,
      ...
      {/* Error */}
      <div>
        <div style={{ background: colors.error.main, height: '120px', borderRadius: borderRadius.lg, marginBottom: '8px' }} />
        <div style={{
          fontFamily: fontFamilies.mono,
          fontSize: '13px',
          color: colors.text.footer,
